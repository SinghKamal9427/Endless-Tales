...
import StepS from "../../public/assets/step2.png";
import SciFi from "../../public/assets/Sci-Fi-icon.png";
import storyScenariosData from "../utilis/storyScenariosData";
import { useContext } from "react";
import { Context } from "../store/createContextStore";

export default function StepSecond({ onNext }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <Image src={StepS} alt="Hero Banner" className="w-[10em] h-[7em] " />
      <div className="font-black text-2xl pb-8">
        {storyScenariosData[0].chooseType}
      </div>
      <div className="flex flex-wrap items-center justify-center gap-4 md:mx-[26%]">
        {storyScenariosData.map((val, inx) => {
          return (
            <div
              key={inx}
