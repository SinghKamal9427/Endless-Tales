...
import StepSx from "../../public/assets/step6.png";
import SciFi from "../../public/assets/Sci-Fi-icon.png";
import storyLanguagesData from "../utilis/storyLanguagesData"
import { useContext } from "react";
import { Context } from "../store/createContextStore";


export default function StepSixth ({ onNext}) {
  ...
  const handleSelect = (val) => {
    ...
    return (
        ...
        <Image src={StepSx} alt="Hero Banner" className="w-[10em] h-[7em] " />
        <div className="font-black text-2xl pb-8">{storyLanguagesData[0].chooseType}</div>
        <div className="flex flex-wrap items-center justify-center gap-4 md:mx-[26%]">
        {storyLanguagesData.map((val,inx)=>{
